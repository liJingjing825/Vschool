...
public class myschoolActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void intn() {
        IVreturnhome=(ImageView)findViewById(R.id.myschoolhomereturn);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.myschoolhomereturn:
                Intent mhrintent=new Intent(myschoolActivity.this,MainActivity.class);
