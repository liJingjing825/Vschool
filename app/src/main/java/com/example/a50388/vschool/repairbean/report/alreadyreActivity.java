...
public class alreadyreActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alreadyre);
    ...
    private void intn() {
        IVreturnhome=(ImageView)findViewById(R.id.alreadyrereturn);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.navigationreturn:
                Intent mhrintent=new Intent(alreadyreActivity.this,studentguideActivity.class);
    ...
    public void drawPie(){
        ...
        sizes.add(new Entry(5,0));
        sizes.add(new Entry(12,1));
        //颜色
