...
/**
 * Created by 50388 on 2018/8/31.
 */

public
class NetUtilcashbookdata extends AppCompatActivity {
     ...
     * @return
     */
    public  String loginOfPost(String accountNo) {
        ...
        try {
            ...
            //post请求的参数
            String data = "accountNo="+accountNo;
            Log.i("hsd",data);
